...
elif os.path.exists("youtube_comments.csv"):
    df = pd.read_csv("youtube_comments.csv")
    st.info("📌 No file uploaded. Using default: `youtube_comments.csv`")
else:
    st.warning("⚠️ Please upload a CSV file with columns: Comment, Polarity, Sentiment.")
    st.stop()
